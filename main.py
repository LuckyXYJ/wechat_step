...
common_headers = {'User-Agent': 'MiFit/5.3.0 (iPhone; iOS 14.7.1; Scale/3.00)'}
...
def login(user, password):
    ...
    print("access_code获取成功！===== ", r1, r1.content)

    location = r1.headers["Location"]
    print("access_code获取成功！===== ", r1, location)
    try:
...
def get_app_token(login_token):
    try:
        ...
        response = requests.get(url=url, headers=common_headers).json()
        print('\n======', response, '\n')
...
def changeStep(user_name, passwd, step):
    print('开始')
    ...
    # login_token = 'NQVBQFJyQktGHlp6QkpbRl5LRl5qek4uXAQEBAAAAAMtd3tD8QpebDeLChHi34JkEA0zz7KGuz8vBjeMtw8CN-hXq963Wy60jYHcDGTTx8Ijc0FFqBL2t_J-SOyj22jb-PftDoG1O0HLaHWq-Cv2pCJ-vyYSkTBxYL1dUy28IG4fsBmxm3SX5uNet08qPS0QD71WmZ4nZLNGYU0KyPZ8HJ-iMnEj_RaF9MGZDcvwIXg0gR2ILHxrBqoJ3_STRvqs'
    # userid = '1090213407'
    print(f'登陆成功，login_token = {login_token}, userid = {userid}')
